...
class ReceptionTableViewControllerXZ: UITableViewController {
    ...
    private func setColor(color: String) {
        let scheduleOptions = self.navigationController?.viewControllers[1] as? ReceptionTableViewController
